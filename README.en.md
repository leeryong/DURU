...
>
> One installer (about 262 MB) and you're done. → **[Download](../../releases/latest)**
...
To hand it to someone, use **Export** inside DURU to write a `.durukb` file.
