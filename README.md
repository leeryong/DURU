...
> <sub>2026-08-21</sub>
>
> 설치 파일 하나(약 230MB)를 받아 실행하면 끝입니다. → **[내려받기](../../releases/latest)**
> 함께 써 볼 수 있는 지식베이스 **「국가 제도·법령 (표본 15편)」** 도 같이 올려 두었습니다.
> 받아서 가져오기만 하면 바로 물어볼 수 있습니다.
...
> [!TIP]
> **법률 분야 「국가 제도·법령 (표본 15편)」이 공개됐습니다.** 배포판과 함께 내려받아
> 가져오기만 하면 바로 물어볼 수 있습니다.

<details>
<summary><sub>무엇이 들었나 — 법제처 국가법령정보센터 법령 원문 15편</sub></summary>

<sub>

대한민국헌법 · 국가공무원법 · 지방자치법 · 행정절차법 · 개인정보 보호법 · 국민건강보험법 ·
주택법 · 국토의 계획 및 이용에 관한 법률 · 재난 및 안전관리 기본법 · 환경영향평가법 ·
독점규제 및 공정거래에 관한 법률 · 하도급거래 공정화에 관한 법률 ·
산업집적활성화 및 공장설립에 관한 법률 · 국가연구개발혁신법 및 같은 법 시행령

대한민국 법령은 저작권법 제7조 제1호에 따른 비보호저작물이라 조건 없이 재배포할 수 있습니다.
...
| | |
| --- | --- |
| **DURU Setup 0.8.0.exe** | 윈도우 10/11 (64비트) · 약 230MB · [내려받기](../../releases/latest) |
| **국가 제도·법령 (표본 15편).durukb** | 함께 써 볼 지식베이스 · 약 70MB · [내려받기](../../releases/latest) |
