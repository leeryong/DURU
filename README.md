...
> ## 📢 윈도우 설치판이 나왔습니다 — **v0.8.4**
>
> <sub>2026-08-26 · 안정화 및 사용성 개선</sub>
>
> 설치 파일 하나(약 370MB)를 받아 실행하면 끝입니다. → **[내려받기](../../releases/latest)**
...
| | |
| --- | --- |
| **DURU-Setup-0.8.4.exe** | 윈도우 10/11 (64비트) · 약 370MB · [내려받기](../../releases/latest) |
