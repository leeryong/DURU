...
| 지식베이스 | 무엇인가 | 나눔 |
| --- | --- | --- |
| **국가 제도·법령 598편** | 한국 사회를 굴리는 **제도 578개의 법적 근거**를 모은 것입니다. 법률 368 · 시행령 109 · 시행규칙 56 · 규정·규칙 46 · 지침·고시 19편으로, **법률에서 시행규칙까지 한 벌**을 갖췄습니다. 위 15편의 완성본입니다. | 연락 주시면 드립니다 — 법령은 저작권 제약이 없지만 **3.7GB**라 여기 올릴 수 없습니다 |
